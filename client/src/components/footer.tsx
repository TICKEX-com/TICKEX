        ...
        <div className="container">
            ...
            <div className="c-footer">
                ...
                <div className="layout_item w-50">
                    ...
                    <h3 className="newsletter_title text-left">Get updates on offers you probably want to know about in your inbox.</h3>
                    <form className='footerform' action="">
                        <input className='footerinput' type="text" placeholder="Email Address"></input>
                        <button>
                ...
                <div className="layout_item w-25">
                    ...
                    <ul className="c-nav-tool_list">
                        <li>
                        <a href="/collections/all" className="c-link">Features</a>
                        </li>
            ...
            <p>&copy; 2024 Tickx Company Inc.</p>
            </div>
        </div>
    </footer>
  )
